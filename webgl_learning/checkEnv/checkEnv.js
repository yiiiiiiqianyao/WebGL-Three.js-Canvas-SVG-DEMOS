...
for (var i = 0; i < params.length; i += 1) {
    ...
    // var gl = canvas.getContext("webgl", params[i]);
    var gl = getWebGLContext(canvas, params[i])
    if (!gl) {
...
function getWebGLContext(canvas, options) {
    var names = ["webgl", "experimental-webgl", "webgl2", "experimental-webgl2"];
    var context = null;
